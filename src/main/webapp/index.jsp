...
//			out.println(String.format("\t\t<tr><td>%d</td><td>%s</td><td>%s</td><td>%s</td><td>%s</td><td>%d</td><td>%s</td><td>%s</td>", i.getId(), i.getOwner(), i.getName(), i.getDescription(), i.getTags(), -1, i.getCreatedDate(), i.getModifiedDate()));
//		out.print("\t</table>");
//	}
%>
</body>
